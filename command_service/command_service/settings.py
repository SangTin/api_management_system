"""
Django settings for command_service project.
...
ROOT_URLCONF = 'command_service.urls'
...
WSGI_APPLICATION = 'command_service.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'command_service_db'),
